    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-col md:flex-row gap-4">
        ...
        <select
          ...
          className="px-4 py-2 bg-[#0a0a0a] border-0 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary"
        >
        ...
        <button
          ...
          className="px-4 py-2 bg-[#0a0a0a] border-0 rounded-lg hover:bg-secondary/80 transition-colors flex items-center gap-2"
        >
        ...
        <div className="bg-card rounded-lg p-6 border border-secondary space-y-6">
          ...
          <div className="space-y-3">
            ...
            <select
              ...
              className="w-full px-4 py-2 bg-[#0a0a0a] border-0 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary"
            >
