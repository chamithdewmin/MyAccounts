...
const invoiceStyles = {
  ...
  invoiceWord: { fontSize: '46px', fontWeight: 600, letterSpacing: '6px', color: '#111111', lineHeight: 1, textAlign: 'right', fontFamily: "'Montserrat', sans-serif" },
  ...
  billToDetail: { fontSize: '13px', color: '#111111', marginTop: '2px' },
  metaRow: { display: 'flex', justifyContent: 'flex-end', gap: '24px', marginBottom: '4px', fontSize: '13px' },
  metaKey: { color: '#555' },
  metaVal: { color: '#111111', fontWeight: 500, minWidth: '120px', textAlign: 'right' },
  ...
  itemTitle: { fontWeight: 600, marginBottom: '2px', fontSize: '13px', color: '#111111' },
        ...
        <div className="no-print" style={{ maxWidth: 680, margin: '0 auto 16px', display: 'flex', justifyContent: 'flex-end', gap: 10 }}>
          <button
            ...
            style={{
              ...
              fontWeight: 600,
              fontSize: 14,
              background: dlStatus === 'loading' ? '#7f1d1d' : dlStatus === 'done' ? '#166534' : '#111111',
              color: '#fff',
              border: 'none',
              borderRadius: 8,
              padding: '12px 28px',
            ...
            onMouseLeave={(e) => { if (dlStatus === 'idle') e.currentTarget.style.background = '#111111'; }}
          >
