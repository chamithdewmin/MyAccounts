...
const invoiceStyles = {
  ...
  row: (extra = {}) => ({ display: 'flex', justifyContent: 'space-between', padding: '5px 0', borderBottom: '1px solid #e1e1e1', ...extra }),
  ...
  sigLine: { borderTop: '1px solid #e1e1e1', width: '140px', margin: '32px auto 4px' },
};
