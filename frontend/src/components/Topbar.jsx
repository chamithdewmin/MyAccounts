      ...
      <div className="flex items-center gap-2 sm:gap-4 px-3 py-2 sm:px-4 sm:py-3 lg:px-6 min-w-0">
        ...
        <div className="relative flex-1 min-w-0 max-w-md">
          ...
          <input
            ...
            className="w-full min-w-0 pl-9 pr-3 py-2.5 sm:pl-10 sm:pr-4 bg-[#0a0a0a] border-0 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary transition-all"
          />
        </div>
      </div>
    </header>
