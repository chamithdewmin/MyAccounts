  ...
  ({ children, collapsible = 'off', className, ...props }, ref) => {
    ...
    return (
      <aside
        ...
        className={cn(
          'fixed top-0 left-0 z-50 flex h-screen flex-col border-r border-border bg-card dark:bg-[#12131A] transition-[width] duration-300 ease-sidebar pt-[env(safe-area-inset-top)]',
