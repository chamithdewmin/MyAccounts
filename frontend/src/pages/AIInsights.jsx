...
const AIInsights = () => {
  ...
  return (
    <>
      <Helmet>
        <title>AI Insights - LogozoPOS</title>
      ...
      <div className="page-y-sm min-w-0">
        ...
        <div className="bg-card rounded-xl border border-border overflow-hidden flex flex-col min-h-[320px] sm:min-h-[400px] md:min-h-[480px] max-h-[calc(100vh-10rem)] sm:max-h-[calc(100vh-11rem)] md:max-h-[calc(100vh-12rem)] h-[calc(100vh-10rem)] sm:h-[calc(100vh-11rem)] md:h-[calc(100vh-12rem)]">
          ...
          >
            ...
            {messages.map((msg, i) =>
              msg.type === 'suggestion' ? (
                ...
                <div key={i} className="rounded-xl bg-secondary/30 border border-border p-4 sm:p-6 space-y-3 sm:space-y-4">
          ...
          <div className="flex-shrink-0 p-4 sm:p-6 pt-3 sm:pt-4 border-t border-border bg-background/30 pb-[env(safe-area-inset-bottom)]">
