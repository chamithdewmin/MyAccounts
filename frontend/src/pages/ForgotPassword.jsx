...
const ForgotPassword = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Forgot Password - LOGOZODEV</title>
        <meta name="description" content="Reset your LOGOZODEV password via OTP" />
      </Helmet>
        ...
        >
          <div className="bg-[#1e1e1e] rounded-3xl shadow-xl p-8 sm:p-10">
            <div className="flex justify-center mb-6">
              <img src={loginLogo} alt="LOGOZODEV" className="h-10 object-contain" />
            </div>
