...
const ForgotPassword = () => {
  ...
  const inputClass = 'h-12 bg-input border border-border text-foreground placeholder:text-muted-foreground';
  ...
  return (
    <>
      <Helmet>
        <title>Forgot Password - LogozoPOS</title>
        <meta name="description" content="Reset your LogozoPOS password via OTP" />
      </Helmet>
        ...
        >
          <div className="bg-[#1e1e1e] rounded-3xl shadow-xl p-8 sm:p-10">
            <div className="flex justify-center mb-6">
              <img src={loginLogo} alt="LogozoPOS" className="h-10 object-contain" />
            </div>
