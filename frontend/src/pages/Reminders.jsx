      ...
      <div className="space-y-6">
        ...
        {loading ? (
          ...
          <motion.div
            ...
            className="bg-[#0a0a0a] border-0 rounded-lg p-12 text-center"
          >
          ...
          <div className="bg-[#0a0a0a] border-0 rounded-lg overflow-hidden">
          ...
          <form onSubmit={handleAddReminder} className="space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full min-h-[80px] px-3 py-2 bg-[#0a0a0a] border-0 rounded-lg resize-none text-sm"
