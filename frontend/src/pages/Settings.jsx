...
import { Save, Building2, Receipt, Landmark, Wallet, Palette, Percent, Trash2 } from 'lucide-react';
...
const Settings = () => {
  const { settings, updateSettings, saveBankDetails, loadData } = useFinance();
