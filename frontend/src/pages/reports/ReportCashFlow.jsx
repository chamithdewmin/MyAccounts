...
export default function CashFlowReport(){
  ...
  const openReportPreview = () => {
    ...
    let body = `<h2 style="margin:0 0 16px; font-size:18px; border-bottom:2px solid #262626; padding-bottom:8px;">Cash Flow Report</h2>`;
    ...
    body += `<tr><td style="padding:10px 12px; border:1px solid #262626;">Total Money In</td><td style="text-align:right; padding:10px 12px; border:1px solid #262626;">${cur} ${totalIn.toLocaleString()}</td></tr>`;
    body += `<tr><td style="padding:10px 12px; border:1px solid #262626;">Total Money Out</td><td style="text-align:right; padding:10px 12px; border:1px solid #262626;">${cur} ${totalOut.toLocaleString()}</td></tr>`;
    body += `<tr><td style="padding:10px 12px; border:1px solid #262626;">Net Cash Flow</td><td style="text-align:right; padding:10px 12px; border:1px solid #262626;">${cur} ${net.toLocaleString()}</td></tr>`;
    body += `<tr><td style="padding:10px 12px; border:1px solid #262626;">Current Balance</td><td style="text-align:right; padding:10px 12px; border:1px solid #262626;">${cur} ${(totals.cashInHand || 0).toLocaleString()}</td></tr></table>`;
    
    // Income details
    if (filteredIncomes.length > 0) {
      body += `<h3 style="margin:20px 0 12px; font-size:14px;">Money In - ${monthName} ${selectedYear}</h3><table style="width:100%; border-collapse:collapse;"><tr style="background:#f5f5f5;"><th style="border:1px solid #262626; padding:8px;">Date</th><th style="border:1px solid #262626; padding:8px;">Source</th><th style="border:1px solid #262626; padding:8px;">Category</th><th style="border:1px solid #262626; padding:8px; text-align:right;">Amount</th></tr>`;
      filteredIncomes.forEach((inc) => {
        body += `<tr><td style="border:1px solid #262626; padding:8px;">${new Date(inc.date).toLocaleDateString()}</td><td style="border:1px solid #262626; padding:8px;">${inc.clientName || '-'}</td><td style="border:1px solid #262626; padding:8px;">${inc.serviceType || '-'}</td><td style="border:1px solid #262626; padding:8px; text-align:right;">${cur} ${(inc.amount || 0).toLocaleString()}</td></tr>`;
      });
      body += `</table>`;
    }
    ...
    if (filteredExpenses.length > 0) {
      body += `<h3 style="margin:20px 0 12px; font-size:14px;">Money Out - ${monthName} ${selectedYear}</h3><table style="width:100%; border-collapse:collapse;"><tr style="background:#f5f5f5;"><th style="border:1px solid #262626; padding:8px;">Date</th><th style="border:1px solid #262626; padding:8px;">Category</th><th style="border:1px solid #262626; padding:8px;">Description</th><th style="border:1px solid #262626; padding:8px; text-align:right;">Amount</th></tr>`;
      filteredExpenses.forEach((exp) => {
        body += `<tr><td style="border:1px solid #262626; padding:8px;">${new Date(exp.date).toLocaleDateString()}</td><td style="border:1px solid #262626; padding:8px;">${exp.category || '-'}</td><td style="border:1px solid #262626; padding:8px;">${exp.description || '-'}</td><td style="border:1px solid #262626; padding:8px; text-align:right;">${cur} ${(exp.amount || 0).toLocaleString()}</td></tr>`;
      });
      body += `</table>`;
    }
    body += `<h3 style="margin:0 0 12px; font-size:14px;">Recent Transactions</h3><table style="width:100%; border-collapse:collapse;"><tr style="background:#f5f5f5;"><th style="text-align:left; padding:8px 12px; border:1px solid #262626;">Date</th><th style="text-align:left; padding:8px 12px; border:1px solid #262626;">Source</th><th style="text-align:right; padding:8px 12px; border:1px solid #262626;">Amount</th><th style="text-align:left; padding:8px 12px; border:1px solid #262626;">Status</th></tr>`;
    filtered.slice(0, 20).forEach((t) => {
      body += `<tr><td style="padding:8px 12px; border:1px solid #262626;">${t.date}</td><td style="padding:8px 12px; border:1px solid #262626;">${t.source}</td><td style="text-align:right; padding:8px 12px; border:1px solid #262626;">${cur} ${Math.abs(t.amount).toLocaleString()}</td><td style="padding:8px 12px; border:1px solid #262626;">${t.status}</td></tr>`;
    });
    body += `</table>`;
