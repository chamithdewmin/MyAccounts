...
// ── COLORS ────────────────────────────────────────────────────────────────────
const C = { bg:"#000000",bg2:"#000000",card:"#1e293b",border:"#000000",border2:"#000000",text:"#fff",text2:"#d1d9e6",muted:"#8b9ab0",faint:"#4a5568",green:"#22c55e",red:"#ef4444",blue:"#0e5cff",cyan:"#22d3ee",yellow:"#eab308",purple:"#a78bfa" };
...
const Tip = ({active,payload,label})=>{
  ...
  return <div style={{background:"#1e293b",border:`1px solid ${C.border2}`,borderRadius:12,padding:"12px 16px",boxShadow:"0 8px 32px rgba(0,0,0,0.5)"}}>
...
export default function ProfitLoss(){
  ...
  return(
    <div className="-mx-3 sm:-mx-4 lg:-mx-5" style={{minHeight:"100vh",fontFamily:"'Inter', -apple-system, BlinkMacSystemFont, sans-serif",color:C.text}}>
      <style>{`*{box-sizing:border-box;}body{margin:0;}::-webkit-scrollbar{width:4px;}::-webkit-scrollbar-thumb{background:${C.border2};border-radius:99px;}@keyframes fi{from{opacity:0;transform:translateY(10px);}to{opacity:1;transform:translateY(0);}}.row:hover{background:#1e293b!important;}`}</style>
        ...
        <div style={{display:"grid",gridTemplateColumns:"2.2fr 1fr",gap:16}}>
          ...
          <Card title="Expense Breakdown" subtitle="By category">
            <ResponsiveContainer width="100%" height={180}>
              ...
              </Pie><Tooltip formatter={v=>`LKR ${v.toLocaleString()}`} contentStyle={{background:"#1e293b",border:`1px solid ${C.border2}`,borderRadius:10}}/></PieChart>
            </ResponsiveContainer>
