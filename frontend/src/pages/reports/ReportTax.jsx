...
export default function TaxReports(){
  ...
  const openReportPreview = () => {
    ...
    let body = `<h2 style="margin:0 0 16px; font-size:18px; border-bottom:2px solid #262626; padding-bottom:8px;">Tax Report</h2>`;
    ...
    body += `<tr><td style="padding:10px 12px; border:1px solid #262626;">Gross Income</td><td style="text-align:right; padding:10px 12px; border:1px solid #262626;">${cur} ${monthlyIncome.toLocaleString()}</td></tr>`;
    body += `<tr><td style="padding:10px 12px; border:1px solid #262626;">Deductions</td><td style="text-align:right; padding:10px 12px; border:1px solid #262626;">${cur} ${monthlyExpense.toLocaleString()}</td></tr>`;
    body += `<tr><td style="padding:10px 12px; border:1px solid #262626;">Taxable Income</td><td style="text-align:right; padding:10px 12px; border:1px solid #262626;">${cur} ${monthlyTaxable.toLocaleString()}</td></tr>`;
    body += `<tr><td style="padding:10px 12px; border:1px solid #262626;">Estimated Tax (${settings.taxRate || 0}%)</td><td style="text-align:right; padding:10px 12px; border:1px solid #262626;">${cur} ${monthlyTax.toLocaleString()}</td></tr></table>`;
    
    // Income details
    if (filteredIncomes.length > 0) {
      body += `<h3 style="margin:20px 0 12px; font-size:14px;">Income Details</h3><table style="width:100%; border-collapse:collapse;"><tr style="background:#f5f5f5;"><th style="border:1px solid #262626; padding:8px;">Date</th><th style="border:1px solid #262626; padding:8px;">Client</th><th style="border:1px solid #262626; padding:8px;">Service</th><th style="border:1px solid #262626; padding:8px; text-align:right;">Amount</th></tr>`;
    ...
    // Year Summary
    body += `<h3 style="margin:20px 0 12px; font-size:14px;">Year ${selectedYear} Quarterly Summary</h3><table style="width:100%; border-collapse:collapse;"><tr style="background:#f5f5f5;"><th style="text-align:left; padding:8px 12px; border:1px solid #262626;">Quarter</th><th style="text-align:right; padding:8px 12px; border:1px solid #262626;">Gross</th><th style="text-align:right; padding:8px 12px; border:1px solid #262626;">Tax Owed</th><th style="text-align:left; padding:8px 12px; border:1px solid #262626;">Status</th></tr>`;
    quarterly.forEach((q) => {
      body += `<tr><td style="padding:8px 12px; border:1px solid #262626;">${q.quarter}</td><td style="text-align:right; padding:8px 12px; border:1px solid #262626;">${cur} ${q.gross.toLocaleString()}</td><td style="text-align:right; padding:8px 12px; border:1px solid #262626;">${cur} ${q.taxOwed.toLocaleString()}</td><td style="padding:8px 12px; border:1px solid #262626;">${q.paid ? "Paid" : "Pending"}</td></tr>`;
    });
    body += `</table>`;
