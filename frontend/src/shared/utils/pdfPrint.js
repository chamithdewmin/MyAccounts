...
/**
 * Wraps report/print content with logo (top-left), optional business name, and "Generated from LogozoPOS" footer.
...
export function getPrintHtml(innerContent, options = {}) {
  ...
  const footer = '<p style="font-size:10px; color:#666; margin-top:16px; padding-top:12px; border-top:1px solid #e1e1e1;">Generated from LogozoPOS</p>';
