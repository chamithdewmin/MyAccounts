...
/**
 * Wraps report/print content with logo (top-left), optional business name, and "Generated from LOGOZODEV" footer.
...
export function getPrintHtml(innerContent, options = {}) {
  ...
  const logoHtml = logo
    ? `<div style="margin-bottom:16px; padding-bottom:12px; border-bottom:2px solid #e1e1e1;">
  ...
  const footer = '<p style="font-size:10px; color:#666; margin-top:16px; padding-top:12px; border-top:1px solid #e1e1e1;">Generated from LOGOZODEV</p>';
